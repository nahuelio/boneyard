...
define(['libs/backbone'], function() {
	...
	/**
	*	Boneyard Core
	*	@namespace com.boneyard.core
	*	@main com.boneyard.core.Boneyard
	**/
	return (function(root) {

		var exports = root.Boneyard = {};
		...
		**/
		var namespace = exports.namespace = function(path, constructor) {
			if(!path || !_.isString(path) || !constructor)
				throw new Error('Boneyard.namespace requires a namespace (in dot notation) and a function (or object)');
		...
		**/
		...
		/**
		*	Boneyard Deep Copy strategy for inheritance.
		*	@static
		*	@method extend
		*	@return Object
		**/
		...
		*	@class com.boneyard.core.Boneyard.Class
		**/
		var Class = exports.Class = namespace('com.boneyard.core.Class', function() {
			this.initialize.apply(this, arguments);
		});

		extend(Class.prototype, Backbone.Events, {

			/**
			*	Default initialize
			*	@public
			*	@method initialize
			*	@return com.boneyard.core.Boneyard.Class
			**/
