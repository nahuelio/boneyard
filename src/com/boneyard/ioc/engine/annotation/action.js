...
define(['ioc/engine/annotation/annotation',
	...
	*	@class com.boneyard.ioc.engine.annotation.Action
	*	@extends com.boneyard.ioc.engine.annotation.Annotation
	*
	*	@requires com.boneyard.ioc.engine.annotation.Annotation
	**/
	var Action = Boneyard.namespace('com.boneyard.ioc.engine.annotation.Action', Annotation.inherit({

		/**
		*	Action's Target
		*	@private
		*	@property _target
		*	@type com.boneyard.ioc.engine.helpers.Dependency
		**/
		_target: null,
