...
define(['ioc/engine/annotation/annotation'], function(Annotation) {
	...
	*	@class com.boneyard.ioc.engine.annotation.Plugin
	*	@extends com.boneyard.ioc.engine.annotation.Annotation
	*
	*	@requires com.boneyard.ioc.engine.annotation.Annotation
	**/
	var Plugin = Boneyard.namespace('com.boneyard.ioc.engine.annotation.Plugin', Annotation.inherit({
		...
		*	@return com.boneyard.ioc.engine.annotation.Plugin
		**/
