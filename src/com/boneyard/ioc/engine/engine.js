/**
*	@module com.boneyard.ioc.engine
...
define(['ioc/engine/helpers/spec',
	...
	/**
	*	Class Engine
	*	@namespace com.boneyard.ioc.engine
	*	@class com.boneyard.ioc.engine.Engine
	*	@extends com.boneyard.core.Boneyard.Class
	*
	*	@requires com.boneyard.ioc.engine.annotation.Spec
	*	@requires com.boneyard.ioc.engine.annotation.Plugin
	...
	**/
	var Engine = Boneyard.namespace('com.boneyard.ioc.engine.Engine', Boneyard.Class.inherit({
		...
		*	@public
		*	@property factory
		*	@type com.boneyard.util.AsyncFactory
		**/
		factory: null,
		...
		*	@public
		*	@property processors
		*	@type com.boneyard.util.adt.Iterator
		**/
		processors: null,
		...
		*	@param ctx {com.boneyard.ioc.Context} context reference
		*	@return com.boneyard.ioc.engine.Engine
		**/
		...
		*	@param spec {com.boneyard.ioc.engine.annotation.Spec} spec annotation
		*	@return Object
		**/
		...
		*	@public
		*	@method exists
		*	@param current {com.boneyard.ioc.engine.helpers.Spec} current spec inside the collection
		...
		*	@return com.boneyard.ioc.engine.annotation.Spec
		**/
		spec: function(id) {
		...
		**/
		EVENTS: {
			...
			*	@event wire
			**/
			wire: 'com:boneyard:ioc:engine:spec:wire',

			/**
			*	@event unwire
			**/
			unwire: 'com:boneyard:ioc:engine:spec:unwire',

			/**
			*	@event plugin
			**/
			plugin: 'com:boneyard:ioc:engine:plugin',

			/**
			*	@event action
			**/
			action: 'com:boneyard:ioc:engine:action'
		},
