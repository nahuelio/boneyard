...
define(['util/exception/ioc/dependency',
	...
	*	@class com.boneyard.ioc.engine.helpers.Dependency
	*	@extends com.boneyard.core.Boneyard.Class
	*
	*	@requires com.boneyard.util.exception.ioc.DependencyException
	**/
	var Dependency = Boneyard.namespace('com.boneyard.ioc.engine.helpers.Dependency', Boneyard.Class.inherit({
		...
		*	@public
		*	@method resolve
		*	@param injector {com.boneyard.ioc.engine.helpers.Injector} injector reference
		*	@return com.boneyard.ioc.engine.helpers.Dependency
		**/
