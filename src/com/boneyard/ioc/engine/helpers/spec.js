...
define(['ioc/engine/annotation/bone',
	...
	*	@class com.boneyard.ioc.engine.annotation.Spec
	*	@extends com.boneyard.core.Boneyard.Class
	*
	*	@requires com.boneyard.ioc.engine.annotation.Bone
	*	@requires com.boneyard.ioc.engine.annotation.Action
	*	@requires com.boneyard.util.adt.Collection
	*	@requires com.boneyard.util.StringUtil
	*	@requires com.boneyard.util.ObjectUtil
	**/
	var Spec = Boneyard.namespace('com.boneyard.ioc.engine.annotation.Spec', Boneyard.Class.inherit({
