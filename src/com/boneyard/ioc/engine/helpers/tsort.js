...
define(['core/boneyard'], function(Boneyard) {
	...
	*	@class com.boneyard.ioc.engine.helpers.TSort
	*	@extends com.boneyard.core.Boneyard.Class
	*
	*	@requires com.boneyard.core.Boneyard
	**/
	var TSort = Boneyard.namespace('com.boneyard.ioc.engine.helpers.TSort', Boneyard.Class.inherit({
		...
		*	@public
		*	@method initialize
		*	@return com.boneyard.ioc.engine.helpers.TSort
		**/
		initialize: function() {
			this.reset();
