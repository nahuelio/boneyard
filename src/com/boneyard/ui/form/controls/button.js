...
define(['ui/view', 'util/string'], function(View, StringUtil) {
	...
	*	@class com.boneyard.ui.form.controls.Button
	*	@extends com.boneyard.ui.View
	*
	*	@requires com.boneyard.ui.View
	**/
	var UIButton = Boneyard.namespace('com.boneyard.ui.form.controls.Button', View.inherit({
		...
		*	@return com.boneyard.ui.form.controls.Button
		**/
		...
		**/
		EVENTS: {
			...
			*	@event clicked
			**/
			clicked: 'com:boneyard:ui:view:form:controls:button:clicked'
		},
