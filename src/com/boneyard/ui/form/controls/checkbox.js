...
define(['ui/form/controls/input', 'util/string'], function(Input, StringUtil) {
	...
	*	@class com.boneyard.ui.form.controls.Checkbox
	...
	**/
	var UICheckbox = Boneyard.namespace('com.boneyard.ui.form.controls.Checkbox', Input.inherit({
		...
		*	@return com.boneyard.ui.form.controls.Checkbox
		**/
