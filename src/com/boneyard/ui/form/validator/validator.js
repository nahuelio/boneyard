/**
*	@module com.boneyard.ui.form.validator
...
define(['util/adt/collection'], function(Collection) {
	...
	/**
	*	Class Validator
	*	@namespace com.boneyard.ui.form.validator
	*	@class com.boneyard.ui.form.validator.Validator
	*	@extends com.boneyard.util.adt.Collection
	*
	*	@requires com.boneyard.util.adt.Collection
	**/
	var Validator = Boneyard.namespace('com.boneyard.ui.form.validator.Validator', Collection.inherit({
		...
		*	@return com.boneyard.ui.form.validator.Validator
		**/
		...
		**/
		EVENTS: {
			...
			*	@event validate
			**/
			validate: 'com:boneyard:ui:form:validator:validate',

			/**
			*	@event valid
			**/
			valid: 'com:boneyard:ui:form:validator:rule:valid',

			/**
			*	@event invalid
			**/
			invalid: 'com:boneyard:ui:form:validator:rule:invalid',

			/**
			*	@event clear
			**/
			clear: 'com:boneyard:ui:form:validator:clear'
		},
