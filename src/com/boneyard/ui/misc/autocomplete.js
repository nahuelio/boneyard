...
define(['ui/container',
	...
	'util/string'], function(Container, Input, List, ListItem, Link, Span, StringUtil) {
		...
		*	@class com.boneyard.ui.misc.Autocomplete
		...
		*	@requires com.boneyard.ui.basic.Span
		*	@requires com.boneyard.util.StringUtil
		**/
		var UIAutocomplete = Boneyard.namespace('com.boneyard.ui.misc.Autocomplete', Container.inherit({
			...
			*	@public
			*	@property input
			*	@type com.boneyard.ui.form.controls.Input
			**/
			input: null,
			...
			*	@return com.boneyard.ui.misc.Autocomplete
			**/
			...
			*	@param view {com.boneyard.ui.View} view reference
			*	@return com.boneyard.ui.misc.Autocomplete
			**/
			...
			*	@return com.boneyard.ui.misc.Autcomplete
			**/
			render: function() {
			...
			*	@public
			*	@method onHighlight
			*	@param item {com.boneyard.ui.list.ListItem} list item reference
			*	@param matched {Boolean} item reference who was matched by the expression
			*	@return com.boneyard.ui.list.ListItem
			**/
			...
			*	@method onSelect
			*	@param e {Object} event reference
			*	@param item {com.boneyard.ui.list.ListItem} item reference
			**/
			...
			**/
			EVENTS: {
				...
				*	@event selected
				**/
				selected: 'com:boneyard:ui:misc:autcomplete:selected'
			}
