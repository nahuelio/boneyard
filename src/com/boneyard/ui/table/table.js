...
define(['ui/container',
	...
	/**
	*	Class Table
	*	@namespace com.boneyard.ui.table
	*	@class com.boneyard.ui.table.Table
	*	@extends com.boneyard.ui.Container
	*
	*	@requires com.boneyard.ui.Container
	**/
	var UITable = Boneyard.namespace('com.boneyard.ui.table.Table', Container.inherit({
		...
		*	@return com.boneyard.ui.table.Table
		**/
		...
		**/
		_create: function(type) {
			return Boneyard.html('tag', { tagName: type, cls: ('ui-table-' + type) });
		},
