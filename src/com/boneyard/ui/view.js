...
define(['core/boneyard',
		...
		'libs/bootstrap'], function(Boneyard, StringUtil, UIException) {

	/**
	*	Class View
	*	@namespace com.boneyard.ui
	*	@class com.boneyard.ui.View
	*	@extends com.boneyard.core.Boneyard.Backbone.View
	*
	...
	**/
	var View = Boneyard.namespace('com.boneyard.ui.View', Backbone.View.inherit({
		...
		*	@private
		*	@property _parent
		*	@type com.boneyard.ui.Container
		**/
		_parent: null,
		...
		**/
		_ensure: function() {
			...
			if(!(this._parent instanceof Boneyard.com.boneyard.ui.Container)) throw new UIException('InvalidSuccessorType');
		...
		**/
		EVENTS: {
			...
			*	@event click
			**/
			click: 'com:boneyard:ui:view:click',
			/**
			*	@event dbclick
			**/
			dbclick: 'com:boneyard:ui:view:dbclick',
			/**
			*	@event mousedown
			**/
			mousedown: 'com:boneyard:ui:view:mousedown',
			/**
			*	@event mouseup
			**/
			mouseup: 'com:boneyard:ui:view:mouseup',
			/**
			*	@event show
			**/
			show: 'com:boneyard:ui:view:show',
			/**
			*	@event hide
			**/
			hide: 'com:boneyard:ui:view:hide',
			/**
			*	@event enable
			**/
			enable: 'com:boneyard:ui:view:enable',
			/**
			*	@event disable
			**/
			disable: 'com:boneyard:ui:view:disable',
			/**
			*	@event render
			**/
			render: 'com:boneyard:ui:view:rendere',
			/**
			*	@event update
			**/
			update: 'com:boneyard:ui:view:update',
			/**
			*	@event detach
			**/
			detach: 'com:boneyard:ui:view:detach'
		}
