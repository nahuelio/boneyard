...
define(['util/factories/factory',
		'util/adt/stack',
		'util/string'], function(Factory, Stack, StringUtil) {
	...
	*	@class com.boneyard.util.factories.AsyncFactory
	*	@extends com.boneyard.util.factories.Factory
	*
	*	@requires com.boneyard.util.factories.Factory
	*	@requires com.boneyard.util.adt.Stack
	*	@requires com.boneyard.util.StringUtil
	**/
	var AsyncFactory = Boneyard.namespace('com.boneyard.util.factories.AsyncFactory', Factory.inherit({

		/**
		*	Factory Stack
		*	@public
		*	@property resources
		*	@type com.boneyard.adt.Stack
		**/
		resources: null,
		...
		**/
		EVENTS: {
			...
			* @event loaded
			**/
			loaded: 'com:boneyard:util:factories:async:loaded',
			/**
			* @event loaded
			**/
			failed: 'com:boneyard:util:factories:async:failed',
			/**
			* @event prepared
			**/
			prepared: 'com:boneyard:util:factories:async:prepared'
		}
