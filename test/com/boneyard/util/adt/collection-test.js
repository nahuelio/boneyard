/**
*	com.boneyard.util.adt.Collection Class Tests
*	@author Patricio Ferreira <3dimentionar@gmail.com>
**/
define(['core/boneyard',
        'util/adt/collection',
        'util/adt/iterator'], function(Boneyard, Collection, Iterator) {

    describe('com.boneyard.util.adt.Collection', function() {

    	describe('#new()', function() {

    		it('Should return a com.boneyard.util.adt.Collection Instance', function() {
                this.testSimple = new Collection();
                expect(this.testSimple).to.be.ok();
                expect(this.testSimple.collection).to.be.a('array');
    		});

            it('Should return a com.boneyard.util.adt.Collection Instance (initial elements)', function() {
            ...
            it('Should return a com.boneyard.util.adt.Collection Instance (with interface)', function() {
            ...
            it('2 Collection instances should have independent \'interfaces\'', function() {
                ...
                this.testCol2 = new Collection([], { interface: Boneyard.Class });
                ...
                expect(this.testCol2.get(0) instanceof Boneyard.Class).to.be.equal(true);
