/**
*	com.boneyard.util.adt.Iterator Class Tests
*	@author Patricio Ferreira <3dimentionar@gmail.com>
**/
define(['util/adt/iterator'], function(Iterator) {

	describe('com.boneyard.util.adt.Iterator', function() {

		describe('#new()', function() {

			it('Should return a com.boneyard.util.adt.Iterator Instance (Empty)', function() {
			...
			it('Should return a com.boneyard.util.adt.Iterator Instance (Initial)', function() {
