/**
*	com.boneyard.util.adt.Queue Class Tests
*	@author Patricio Ferreira <3dimentionar@gmail.com>
**/
define(['core/boneyard', 'util/adt/queue'], function(Boneyard, Queue) {

	describe('com.boneyard.util.adt.Queue', function() {

		describe('#new()', function() {

			it('Should return an com.boneyard.util.adt.Queue Instance', function() {
			...
			it('Should return an com.boneyard.util.adt.Queue (initial elements)', function() {
			...
			it('Should return an com.boneyard.util.adt.Queue (With interface)', function() {
				this.testInterface = new Queue([], { capacity: 2, interface: Boneyard.Class });
