...
var Build = {
	...
	**/
	...
	/**
	*	Injects Bundles inside the Boneyard Libs Package to
	...
	**/
	banner: function() {
		...
		_.each(this.config.project.modules, function(m) {
			if(m.name !== 'boneyard-libs') {
				if(m.name === 'boneyard-core') this.versioning(m);
	...
	/**
	*	Injects Version into boneyard-core package
	*	@public
	*	@method versioning
